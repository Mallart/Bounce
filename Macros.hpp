...
#define public_GET_public_SET(type, property) public: type property; void Set##property(type value) { this->##property = value; }; type const Get##property() { return this->##property; }
#define public_GET_protected_SET(type, property) protected: type property; void Set##property(type value) { this->##property = value; }; public: type const Get##property() { return this->##property; }
#define public_GET_private_SET(type, property) private: type property; void Set##property(type value) { this->##property = value; }; public: type const Get##property() { return this->##property; }
#define protected_GET_protected_SET(type, property) protected: type property; void Set##property(type value) { this->##property = value; }; type const Get##property() { return this->##property; }
